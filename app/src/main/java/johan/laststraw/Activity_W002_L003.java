...
/**
 * Created by Johan on 2015-01-01.
 */
public class Activity_W002_L003 extends Activity implements View.OnClickListener, Animation.AnimationListener {
    ...
    String enemyCard1Name = "Steal", enemyCard2Name = "Speed Up", enemyCard3Name = "Agony", enemyCard4Name = "Reinforce III",
            enemyCard5Name = "Reinforce III", enemyCard6Name = "Corruption";
    ...
    int enemyCard1Cost = 1, enemyCard2Cost = 1, enemyCard3Cost = 2, enemyCard4Cost = 1,
        ...
        switch (v.getId()) {
            case R.id.ibPlayerCard1:
                ...
                if (playerCard1Type != 0 && playerMoves >= getCardCost() + playerCorruptedPenalty && objectsRemaining != 0) {
                    ...
                    playCardConfirm(message, Activity_W002_L003.this);
                }
                break;
    ...
    private void gameOver() {
        ...
        myHandler.postDelayed(new Runnable() {
            public void run() {
                final Dialog dialog = new Dialog(Activity_W002_L003.this);
    ...
    private void checkLevelInfo(){
        if (lvlcleared == 0){
            ...
            if (finalPlayerScore > lvlhighscore){
                cursor = db.getLvlInfo(11);
                if (cursor != null && cursor.moveToFirst()) {
                    if (playerWon){
                        db.updateLvlInfo(11, 1, finalPlayerScore);
                    } else {
                        db.updateLvlInfo(11, lvlcleared, finalPlayerScore);
                    }
                }
            } else {
                ...
                if (cursor != null && cursor.moveToFirst()) {
                    if (playerWon){
                        db.updateLvlInfo(11, 1, lvlhighscore);
                    } else {
                        db.updateLvlInfo(11, lvlcleared, lvlhighscore);
                    }
                }
            }
    ...
    private void setEnemyCardsIcons(){
        ...
        if (!sizeName.equals("xlarge")){
            ...
            enemyCard5.setImageResource(R.drawable.card_type_field_tablet);
        }
    ...
    *  -----------------------------------------*/
    ...
    private void coinFlipStart(){
        ...
        myHandler.postDelayed(new Runnable() {
            public void run() {
                chooseCoinSide(Activity_W002_L003.this);
            }
        }, 1500);
    }
