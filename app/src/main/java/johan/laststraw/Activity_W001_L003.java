 ...
 */
public class Activity_W001_L003 extends Activity implements View.OnClickListener, Animation.AnimationListener {
    ...
    String playerGender = "";
    String playerName = "";
    String enemyName = "Farmhand Jack";
    ...
    String enemyCard1Name = "Reinforce", enemyCard2Name = "Reinforce II", enemyCard3Name = "Slow Down", enemyCard4Name = "",
        ...
        switch (v.getId()) {
            case R.id.ibPlayerCard1:
                ...
                if (playerCard1Type != 0 && playerMoves >= getCardCost() + playerCorruptedPenalty && objectsRemaining != 0) {
                    ...
                    playCardConfirm(message, Activity_W001_L003.this);
                }
                break;
    ...
    private void gameOver() {
        ...
        myHandler.postDelayed(new Runnable() {
            public void run() {
                final Dialog dialog = new Dialog(Activity_W001_L003.this);
    ...
    private void checkLevelInfo(){
        if (lvlcleared == 0){
            ...
            if (finalPlayerScore > lvlhighscore){
                cursor = db.getLvlInfo(3);
                if (cursor != null && cursor.moveToFirst()) {
                    if (playerWon){
                        db.updateLvlInfo(3, 1, finalPlayerScore);
                    } else {
                        db.updateLvlInfo(3, lvlcleared, finalPlayerScore);
                    }
                }
            } else {
                cursor = db.getLvlInfo(3);
                if (cursor != null && cursor.moveToFirst()) {
                    if (playerWon){
                        db.updateLvlInfo(3, 1, lvlhighscore);
                    } else {
                        db.updateLvlInfo(3, lvlcleared, lvlhighscore);
                    }
                }
            }
    ...
    *  -----------------------------------------*/
    ...
    private void coinFlipStart(){
        ...
        myHandler.postDelayed(new Runnable() {
            public void run() {
                chooseCoinSide(Activity_W001_L003.this);
            }
        }, 1500);
    }
