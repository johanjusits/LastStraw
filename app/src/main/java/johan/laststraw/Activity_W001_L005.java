 ...
 */
public class Activity_W001_L005 extends Activity implements View.OnClickListener, Animation.AnimationListener {
    ...
    String playerGender = "";
    String playerName = "";
    String enemyName = "Farmhand Nick";
    ...
    String enemyCard1Name = "Reinforce II", enemyCard2Name = "Reinforce II", enemyCard3Name = "Slow Down", enemyCard4Name = "",
    ...
    int enemyCard1Cost = 0, enemyCard2Cost = 0, enemyCard3Cost = 1, enemyCard4Cost = 1,
        ...
        switch (v.getId()) {
            case R.id.ibPlayerCard1:
                ...
                if (playerCard1Type != 0 && playerMoves >= getCardCost() + playerCorruptedPenalty && objectsRemaining != 0) {
                    ...
                    playCardConfirm(message, Activity_W001_L005.this);
                }
                break;
    ...
    private void gameOver() {
        ...
        myHandler.postDelayed(new Runnable() {
            public void run() {
                final Dialog dialog = new Dialog(Activity_W001_L005.this);
    ...
    private void checkLevelInfo(){
        if (lvlcleared == 0){
            ...
            if (finalPlayerScore > lvlhighscore){
                cursor = db.getLvlInfo(5);
                if (cursor != null && cursor.moveToFirst()) {
                    if (playerWon){
                        db.updateLvlInfo(5, 1, finalPlayerScore);
                    } else {
                        db.updateLvlInfo(5, lvlcleared, finalPlayerScore);
                    }
                }
            } else {
                cursor = db.getLvlInfo(5);
                if (cursor != null && cursor.moveToFirst()) {
                    if (playerWon){
                        db.updateLvlInfo(5, 1, lvlhighscore);
                    } else {
                        db.updateLvlInfo(5, lvlcleared, lvlhighscore);
                    }
                }
            }
    ...
    *  -----------------------------------------*/
    ...
    private void coinFlipStart(){
        ...
        myHandler.postDelayed(new Runnable() {
            public void run() {
                chooseCoinSide(Activity_W001_L005.this);
            }
        }, 1500);
    }
