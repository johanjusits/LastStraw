...
/**
 * Created by Johan on 2015-01-30.
 */
public class Activity_Woods_LevelSelection extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_woodslvlselection);
