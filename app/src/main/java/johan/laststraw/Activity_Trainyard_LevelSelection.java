...
/**
 * Created by Johan on 2015-02-01.
 */
public class Activity_Trainyard_LevelSelection extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trainlvlselection);
