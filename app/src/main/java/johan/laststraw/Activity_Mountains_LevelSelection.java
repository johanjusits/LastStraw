...
public class Activity_Mountains_LevelSelection extends Activity implements View.OnClickListener {
    ...
    private void unlockLevels(){
        if (lv001Cleared == 1){
            bLv002.setImageResource(R.drawable.icon_mountains);
            bLv002.setBackgroundResource(R.drawable.lvlselection_button);
            bLv002.setClickable(true);
        }
        if (lv002Cleared == 1){
            bLv003.setImageResource(R.drawable.icon_mountains);
