 ...
 */
public class Activity_Mountains_LevelSelection extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bWorld001Lvl001:
                ...
                editor.putString("LevelName", "World 3 - Level 1");
            ...
            case R.id.bWorld001Lvl002:
                ...
                editor.putString("LevelToLoad", ".Activity_PlayGame");
                editor.putString("LevelName", "World 3 - Level 2");
            ...
            case R.id.bWorld001Lvl003:
                ...
                editor = preferences.edit();
                editor.putString("LevelToLoad", ".Activity_PlayGame");
                editor.putString("LevelName", "World 3 - Level 3");
            ...
            case R.id.bWorld001Lvl004:
                ...
                editor = preferences.edit();
                editor.putString("LevelToLoad", ".Activity_PlayGame");
                editor.putString("LevelName", "World 3 - Level 4");
            ...
            case R.id.bWorld001Lvl005:
                ...
                editor = preferences.edit();
                editor.putString("LevelToLoad", ".Activity_PlayGame");
                editor.putString("LevelName", "World 3 - Level 5");
            ...
            case R.id.bWorld001Lvl006:
                ...
                editor = preferences.edit();
                editor.putString("LevelToLoad", ".Activity_PlayGame");
                editor.putString("LevelName", "World 3 - Level 6");
            ...
            case R.id.bWorld001Lvl007:
                ...
                editor = preferences.edit();
                editor.putString("LevelToLoad", ".Activity_PlayGame");
                editor.putString("LevelName", "World 3 - Level 7");
            ...
            case R.id.bWorld001Lvl008:
                ...
                editor = preferences.edit();
                editor.putString("LevelToLoad", ".Activity_PlayGame");
                editor.putString("LevelName", "World 3 - Level 8");
