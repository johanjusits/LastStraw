 ...
 */
public class Activity_W001_L002 extends Activity implements View.OnClickListener, Animation.AnimationListener {
    ...
    String playerGender = "";
    String playerName = "";
    String enemyName = "Farmhand Zack";
    ...
    int selectedCard = 0;
    int enemyPickedCard;
    int enemyStartingCards = 2;
    int enemyCardsRemaining = 2;
    int lvlcleared;
    int lvlhighscore;
    int lvlId;
        ...
        switch (v.getId()) {
            case R.id.ibPlayerCard1:
                ...
                if (playerCard1Type != 0 && playerMoves >= getCardCost() + playerCorruptedPenalty && objectsRemaining != 0) {
                    ...
                    playCardConfirm(message, Activity_W001_L002.this);
                }
                break;
    ...
    private void checkLevelInfo(){
        if (lvlcleared == 0){
            ...
            if (finalPlayerScore > lvlhighscore){
                cursor = db.getLvlInfo(2);
                if (cursor != null && cursor.moveToFirst()) {
                    if (playerWon){
                        db.updateLvlInfo(2, 1, finalPlayerScore);
                    } else {
                        db.updateLvlInfo(2, lvlcleared, finalPlayerScore);
                    }
                }
            } else {
                cursor = db.getLvlInfo(2);
                if (cursor != null && cursor.moveToFirst()) {
                    if (playerWon){
                        db.updateLvlInfo(2, 1, lvlhighscore);
                    } else {
                        db.updateLvlInfo(2, lvlcleared, lvlhighscore);
                    }
                }
            }
    ...
    *  -----------------------------------------*/
    ...
    private void coinFlipStart(){
        ...
        myHandler.postDelayed(new Runnable() {
            public void run() {
                chooseCoinSide(Activity_W001_L002.this);
            }
        }, 1500);
    }
