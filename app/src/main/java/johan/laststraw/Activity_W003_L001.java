 ...
 */
public class Activity_W003_L001 extends Activity implements View.OnClickListener, Animation.AnimationListener {
    ...
    String enemyCard1Name = "Concentrate", enemyCard2Name = "Speed Up", enemyCard3Name = "Steal II", enemyCard4Name = "Steal II",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_world003);
        ...
        ivEnemyPortrait.setImageResource(R.drawable.portrait_mountains);
        ...
        String objectImgName = "object_snowman";
        String objectBrokenImgName = "object_snowman_broken";
        String objectWebbedImgName = "object_snowman_webbed";
        ...
        switch (v.getId()) {
            case R.id.ibPlayerCard1:
                ...
                if (playerCard1Type != 0 && playerMoves >= getCardCost() + playerCorruptedPenalty && objectsRemaining != 0) {
                    ...
                    playCardConfirm(message, Activity_W003_L001.this);
                }
                break;
    ...
    private void gameOver() {
        ...
        myHandler.postDelayed(new Runnable() {
            public void run() {
                final Dialog dialog = new Dialog(Activity_W003_L001.this);
        ...
        if (lvlcleared == 0){
            ...
            if (finalPlayerScore > lvlhighscore){
                ...
                if (cursor != null && cursor.moveToFirst()) {
                    if (playerWon){
                        db.updateLvlInfo(17, 1, finalPlayerScore);
                    } else {
                        db.updateLvlInfo(17, lvlcleared, finalPlayerScore);
                    }
                }
            } else {
                cursor = db.getLvlInfo(17);
                if (cursor != null && cursor.moveToFirst()) {
                    if (playerWon){
                        db.updateLvlInfo(17, 1, lvlhighscore);
                    } else {
                        db.updateLvlInfo(17, lvlcleared, lvlhighscore);
                    }
                }
            }
    ...
    *  -----------------------------------------*/
    ...
    private void coinFlipStart(){
        ...
        myHandler.postDelayed(new Runnable() {
            public void run() {
                chooseCoinSide(Activity_W003_L001.this);
            }
        }, 1500);
    }
