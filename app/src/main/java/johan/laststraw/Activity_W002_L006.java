 ...
 */
public class Activity_W002_L006 extends Activity implements View.OnClickListener, Animation.AnimationListener {
    ...
    String enemyCard1Name = "Speed Up", enemyCard2Name = "Curse", enemyCard3Name = "Steal II", enemyCard4Name = "",
    ...
    int enemyCard1Cost = 1, enemyCard2Cost = 2, enemyCard3Cost = 2, enemyCard4Cost = 0,
        ...
        switch (v.getId()) {
            case R.id.ibPlayerCard1:
                ...
                if (playerCard1Type != 0 && playerMoves >= getCardCost() + playerCorruptedPenalty && objectsRemaining != 0) {
                    ...
                    playCardConfirm(message, Activity_W002_L006.this);
                }
                break;
    ...
    private void gameOver() {
        ...
        myHandler.postDelayed(new Runnable() {
            public void run() {
                final Dialog dialog = new Dialog(Activity_W002_L006.this);
    ...
    private void checkLevelInfo(){
        if (lvlcleared == 0){
            ...
            if (finalPlayerScore > lvlhighscore){
                cursor = db.getLvlInfo(14);
                if (cursor != null && cursor.moveToFirst()) {
                    if (playerWon){
                        db.updateLvlInfo(14, 1, finalPlayerScore);
                    } else {
                        db.updateLvlInfo(14, lvlcleared, finalPlayerScore);
                    }
                }
            } else {
                cursor = db.getLvlInfo(14);
                if (cursor != null && cursor.moveToFirst()) {
                    if (playerWon){
                        db.updateLvlInfo(14, 1, lvlhighscore);
                    } else {
                        db.updateLvlInfo(14, lvlcleared, lvlhighscore);
                    }
                }
            }
    ...
    private void setEnemyCardsIcons(){
        ...
        if (!sizeName.equals("xlarge")){
            ...
            enemyCard4.setImageResource(R.drawable.card_type_ailment_tablet);
        }
    ...
    *  -----------------------------------------*/
    ...
    private void coinFlipStart(){
        ...
        myHandler.postDelayed(new Runnable() {
            public void run() {
                chooseCoinSide(Activity_W002_L006.this);
            }
        }, 1500);
    }
